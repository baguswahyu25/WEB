...
class FormPendaftaranController extends Controller
{
    public function store(Request $request)
    {
        ...
        // 🔎 Cek apakah user masih punya pendaftaran aktif
        ...
        // 🔎 Ambil paket berdasarkan nama ATAU tipe
        $paket = PaketKursus::where('nama', $validated['paket'])
                    ->orWhere('tipe', $validated['paket'])
                    ->firstOrFail();
        ...
        try {
            ...
            return redirect()->route('payment.snap', $pendaftaran->id);
