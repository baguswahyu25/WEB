            ...
            Route::prefix('v1')->middleware('auth:sanctum')->group(function () {
                ...
                Route::get('transaction/next/{pendaftaran_id}',[TransactionController::class, 'next']);
                Route::post('/payment/retry/{transactionId}', [TransactionController::class, 'retryPayment']);
